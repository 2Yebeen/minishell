...
static void	lstadd_env_node(char *key, char *value, t_environ **env_list);
static void	env_lstadd_back(t_environ **env_list, t_environ *new);
static t_environ	*env_lstnew(char *key, char *value);
static t_environ	*env_lstlast(t_environ *env_list);
